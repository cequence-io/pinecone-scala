...
trait PineconeVectorService extends PineconeServiceConsts {
   ...
   *
   * @return IndexStats
   * @see <a href="https://docs.pinecone.io/reference/describe_index_stats_post">Pinecone Doc</a>
   */
  ...
  /**
   * The Query operation searches a namespace, using an unique id of the vector.
   * It retrieves the ids of the most similar items in a namespace, along with their similarity scores.
   *
   * @param id The unique ID of the vector to be used as a query vector.
   * @param namespace
   * @param settings
   * @return QueryResult
   * @see <a href="https://docs.pinecone.io/reference/query">Pinecone Doc</a>
   ...
   * @return N/A
   * @see <a href="https://docs.pinecone.io/reference/delete_post">Pinecone Doc</a>
   */
  def delete(
    ids: Seq[String],
    namespace: String
   ...
   *
   * @param filter The metadata filter here will be used to select the vectors to delete.
   ...
   *
   * @param id The vector IDs to fetch. Does not accept values containing spaces.
   * @param namespace
   * @return
   * @see <a href="https://docs.pinecone.io/reference/fetch">Pinecone Doc</a>
   */
  def fetch(
    ids: Seq[String],
    namespace: String
   ...
   *
   * @param id Vector's unique id.
   * @param namespace The namespace containing the vector to update.
   * @param values Vector data.
   * @param sparseValues Vector sparse data. Represented as a list of indices and a list of corresponded values, which must be the same length.
   * @param setMetaData Metadata to set for the vector.
   * @return N/A
   * @see <a href="https://docs.pinecone.io/reference/update">Pinecone Doc</a>
   */
  def update(
    id: String,
    namespace: String,
   ...
   *
   * @param vectors An array containing the vectors to upsert. Recommended batch limit is 100 vectors.
   * @param namespace This is the namespace name where you upsert vectors.
   * @return The number of vectors upserted.
   * @see <a href="https://docs.pinecone.io/reference/upsert">Pinecone Doc</a>
   */
  def upsert(
    vectors: Seq[PVector],
    namespace: String
